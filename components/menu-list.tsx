              ...
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Tienda fictica para proyecto de negocios electronicos II.
                    </p>
                    </Link>
                </NavigationMenuLink>
              </li>
...
const components: { title: string; href: string; description: string }[] = [
    {
      ...
      href: "/category/grano",
      description:
        "Cafe entero para moler al gusto.",
    },
    {
      title: "Cafe molido",
      href: "/category/molido",
      description:
        "Cafe molido listo para preparar.",
    },
    {
      title: "Cafe en capsula",
      href: "/category/capsula",
      description:
        "Cafe en capsula para preparar en maquina.",
    },
  ]
